...
namespace Zeeyo.Domain.Extensions;
...
public static class CollectionExtension
{
      ...
      where TEntity : Auditable
    {
        ...
        return @params.PageIndex > 0 && @params.PageSize > 0 ?
            ...
            : throw new ZeeyoException(400, "Please, enter valid numbers");
    }
        ...
        PaginationParams @params)
    {
        ...
        {
            throw new ArgumentOutOfRangeException(nameof(@params.PageSize), "The page size must be greater than 1 or equal to 1.");
        }
